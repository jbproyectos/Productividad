                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?= $ticket['supervisor_nombre'] 
                                    ? htmlspecialchars($ticket['supervisor_nombre']) 
                                    : 'Pendiente de asignación' ?>
                            </td>
                            
                            <!-- Columna Ejecutante -->
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?= $ticket['ejecutante_nombre'] 
                                    ? htmlspecialchars($ticket['ejecutante_nombre']) 
                                    : 'Pendiente de asignación' ?>
                            </td>
                                ...
                                <?php if ($ticket['estado'] === 'Cerrado'): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <button onclick="mostrarEvaluacion('<?= ltrim($ticket['folio'], '#') ?>', '<?= $ticket['id_ejecutante'] ?>')" 
                                                class="inline-flex items-center px-3 py-1.5 bg-purple-50 text-purple-700 rounded-lg border border-purple-200 hover:bg-purple-100 transition-colors duration-200"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex items-center">
                                ...
                                // Número del grupo de WhatsApp (en formato internacional, sin + ni espacios)
